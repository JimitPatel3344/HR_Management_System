...
<body>
	...
	Logid: <input type="number" name="Ulogid" placeholder="Enter your login Id"/><br/>
	Eid: <input type="number" name="Ueid" placeholder="Enter your employee Id"/><br/>
	Password: <input type="password" name="Upassword" placeholder="Enter your password"/><br/>
	Rid: <input type="number" name="Urid" placeholder="Enter your Role Id"/><br/>
