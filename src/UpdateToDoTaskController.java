...
/**
 * Servlet implementation class UpdateToDoTaskController
 */
@WebServlet("/ToDoTaskUpdate")
public class UpdateToDoTaskController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateToDoTaskController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
			...
			tas.setTstatus(Integer.parseInt(request.getParameter("tstatus")));
			if(UpdateTaskDao.updateToDoTask(tas)==true) 
			{
				//out.print("Project updated successfully!!!");
				response.sendRedirect("ViewToDoTasks.jsp");
